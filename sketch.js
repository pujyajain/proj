     ...
     if (frameCount % 60 === 0) {
      ...
      var rand = Math.round(random(1,10));
                     switch(rand){
                         ...
                         break;
                         case 5: choclate.addImage("fruit1", choclate6Image);choclate.scale = 0.1;
                         break;
                         case 6: choclate.addImage("fruit1", choclate1Image);choclate.scale = 0.04;
                         break;
                         
                         case 8: choclate.addImage("fruit1", choclate5Image);choclate.scale = 0.1;
                         break;
                         case 7: choclate.addImage("fruit1", choclate7Image);choclate.scale = 0.1;
                         break;
